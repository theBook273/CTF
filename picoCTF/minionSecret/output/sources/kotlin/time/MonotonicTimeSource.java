...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1594boximpl(m1588markNowz9LOYto());
    }
    ...
    public long m1588markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1597constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1587elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1586differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m1585adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1597constructorimpl(LongSaturatedMathKt.m1583saturatingAddpTJri5U(timeMark, duration));
    }
}
