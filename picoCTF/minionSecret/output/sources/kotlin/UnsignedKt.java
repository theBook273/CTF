...
public final class UnsignedKt {
    ...
    public static final int m480uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m224constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m482ulongDivideeb3DHEI(long v1, long v2) {
        ...
        return ULong.m303constructorimpl(((long) (Long.compare(ULong.m303constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m303constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)) + quotient);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m224constructorimpl((int) v) : UInt.m224constructorimpl(UInt.m224constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m224constructorimpl(Integer.MAX_VALUE));
    }
